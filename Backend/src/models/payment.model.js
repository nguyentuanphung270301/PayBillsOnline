...
Payment.getExcelMeter = function (excelData, callback) {
  const { interval, start_date, end_date, service_id, supplier_id } = excelData;
  let intervalClause = '';
  let groupClause = '';
  let dateFilter = '';
  let queryParams = [];
...
Payment.getExcelCab = function (excelData, callback) {
  const { interval, start_date, end_date, service_id, supplier_id } = excelData;
  let intervalClause = '';
  let groupClause = '';
  let dateFilter = '';
